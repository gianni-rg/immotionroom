namespace ImmotionAR.ImmotionRoom.TrackingEngine
{
    ...
    /// </summary>
    internal class JointsPositionDoubleExponentialFilter
    {
        /// <summary>
        ///     The previous data.
        /// </summary>
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="JointsPositionDoubleExponentialFilter" /> class.
        /// </summary>
        public JointsPositionDoubleExponentialFilter()
        {
            m_Init = false;
        }
        ...
        /// </param>
        private void Init(float smoothingValue = 0.25f, float correctionValue = 0.25f, float predictionValue = 0.25f, float jitterRadiusValue = 0.03f, float maxDeviationRadiusValue = 0.05f)
        {
        ...
        private BodyJointData FilterJoint(BodyData bodyData, BodyJointTypes jt, TransformSmoothParameters smoothingParameters)
        {
            ...
            var j = new BodyJointData(predictedPosition, bodyData.Joints[jt].Confidence, jt);
