namespace ImmotionAR.ImmotionRoom.TrackingService.ControlApi
{
    ...
    public class TrackingServiceControlApiServer : ITrackingServiceControlApiServer
    {
        #region Private fields

        private readonly ILogger m_Logger;
        private readonly TrackingServiceConfiguration m_Configuration;
        ...
        public TrackingServiceControlApiServer(TrackingServiceConfiguration configuration)
        {
            m_Logger = LoggerService.GetLogger<TrackingServiceControlApiServer>();
