namespace ImmotionAR.ImmotionRoom.TrackingService
{
    ...
    public static class Configuration
    {
        ...
        public static TrackingServiceConfiguration LoadConfigurationFromAppConfig()
        {
            ...
            configuration.NetworkAdapterIndex = GetIntSettingsFromAppConfig("NetworkAdapterIndex") ?? TrackingServiceDefaultSettings.NetworkAdapterIndex;
        ...
        public static ILoggerConfiguration LoadLoggerConfiguration(bool diagnosticMode)
        {
            ...
            var logRootFolder = Path.Combine(Path.GetTempPath(),"ImmotionAR\\ImmotionRoom\\TrackingService");
            ...
            var loggerConfig = new LoggerConfiguration
            {
                ...
                AppendToFile = true,
                LogFile = Path.Combine(logRootFolder, "Logs\\TrackingService"),
