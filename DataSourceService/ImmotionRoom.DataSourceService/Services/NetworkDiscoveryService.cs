namespace ImmotionAR.ImmotionRoom.DataSourceService.Services
{
    ...
    public class NetworkDiscoveryService : BaseService, INetworkDiscoveryService
    {
        ...
        public event EventHandler<TrackingServiceFoundEventArgs> TrackingServiceFound;
        ...
        public NetworkDiscoveryService(IConfigurationService configurationService, IUdpClientFactory udpClientFactory) : base(LoggerService.GetLogger<NetworkDiscoveryService>())
        {
            ...
            m_AutoDiscoveryListener = new AutoDiscoveryListener(ListenerTypes.DataSourceListener, udpClientFactory);
            m_AutoDiscoveryDiscoverer = new AutoDiscoveryDiscoverer(DiscovererTypes.TrackingServiceDiscoverer, udpClientFactory);
        }
        ...
        {
            var trackingService = new TrackingServiceInfo
            {
                Id = e.Info.Id,
            ...
            OnTrackingServiceFound(trackingService, e.Info.LicenseId);
        }
        ...
        private void OnTrackingServiceFound(TrackingServiceInfo trackingService, string licenseId)
        {
            EventHandler<TrackingServiceFoundEventArgs> localHandler = TrackingServiceFound;
            if (localHandler != null)
            {
                localHandler(this, new TrackingServiceFoundEventArgs(trackingService, licenseId));
            }
        }
