namespace ImmotionAR.ImmotionRoom.DataSourceService.Views
{
    ...
    public partial class StatusWindow : Window
    {
        ...
        public StatusWindow(IMessenger messenger, IDataSourceService dataSourceService, IDataSourceControlApiServer dataSourceControlApiServer, bool isDiagnosticMode)
        {
            InitializeComponent();

            SetPosition();

            DataContext = new StatusWindowViewModel(messenger, dataSourceService, dataSourceControlApiServer, isDiagnosticMode);
        }
