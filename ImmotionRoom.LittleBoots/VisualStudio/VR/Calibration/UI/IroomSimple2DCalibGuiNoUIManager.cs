namespace ImmotionAR.ImmotionRoom.LittleBoots.VR.Calibration.UI
{
    ...
    /// <summary>
    /// Manages the graphical interface of the standard Iroom/headset calibration GUI, without using UI Unity elements
    /// </summary>
        ...
        IRoomCalibGuiManager
    {
        ...
        /// </summary>
        [Tooltip("Additional background image panel, to set the correct background of calibration UI")]
        public Renderer PanelBackground;
        ...
        /// </summary>
        private IroomSimple2DCalibGuiNoUIManagerInternal m_internalImplementation;
        ...
        void Awake()
        {
            m_internalImplementation = new IroomSimple2DCalibGuiNoUIManagerInternal(this);
        }
