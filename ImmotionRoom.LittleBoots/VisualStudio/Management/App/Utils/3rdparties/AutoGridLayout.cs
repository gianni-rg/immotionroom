namespace ImmotionAR.ImmotionRoom.LittleBoots.Management.App.Utils._3dparties
{
    ...
    {
        // GIANNI, made public for obfuscation issues
        [SerializeField]
        public bool m_IsColumn = false;
        [SerializeField]
        public int m_Column = 1, m_Row = 1;
        [SerializeField]
        public Vector2 m_maxCellDimension = new Vector2(float.MaxValue, float.MaxValue);
