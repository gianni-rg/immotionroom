namespace ImmotionAR.ImmotionRoom.LittleBoots.Management.Editor
{
    ...
    public class AutoGridLayoutGroupEditor : Editor
    {
        ...
        SerializedProperty m_maxCellDimension;
        ...
        protected virtual void OnEnable()
        {
            ...
            m_maxCellDimension = serializedObject.FindProperty("m_maxCellDimension");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_maxCellDimension, true);
